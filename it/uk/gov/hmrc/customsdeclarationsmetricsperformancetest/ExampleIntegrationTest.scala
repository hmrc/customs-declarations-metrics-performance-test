package uk.gov.hmrc.customsdeclarationsmetricsperformancetest
...
class ExampleIntegrationTest extends WordSpec with Matchers with ServiceSpec  {
  ...
  "This integration test" should {
    "start services via smserver" in {
      ...
      val response = wsClient.url(resource("/customs-declarations-metrics-performance-test/hello-world")).get.futureValue
